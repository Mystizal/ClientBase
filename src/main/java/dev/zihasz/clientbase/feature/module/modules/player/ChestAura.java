package dev.zihasz.clientbase.feature.module.modules.player;
...
public class ChestAura extends Module {
	...
	public ChestAura() {
		super("ChestAura", "opens chest things", Category.PLAYER);
	}
	...
	public void onUpdate() {
		TileEntityShulkerBox box = (TileEntityShulkerBox) mc.world.loadedTileEntityList.stream()
				.filter(tileEntity -> tileEntity instanceof TileEntityShulkerBox && shulkerOnly.getValue())
